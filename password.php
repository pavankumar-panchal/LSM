...
if($_POST['send'])
{
	...
	if($message == "")
	{
		...
		if($message == "")
		{
			...
			$FromAddress =  "dealers@relyonsoft.com";
			...
			$array = array();
			$array[] = "##EMAIL##%^%".$email;
			$array[] = "##LOGINNAME##%^%".$username;
			$array[] = "##PASSWORD##%^%".$password;
			
			$msg = file_get_contents("./inc/mail-password-user.htm");
			...
			$html = $msg;
			rslmail($FromName,$FromAddress,$toarray,$MailSubject,$text,$html,$ccarray,$bccarray,$filearray,$replyto);
			$message = "Login details have been emailed to ".$email.".";
...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="pageheader"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="28"><table width="99%" border="0" align="center" cellpadding="2" cellspacing="0" class="header1">
          <tr>
          ...
          <tr>
            <td height="54"><table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
              <tr>
                ...
                <td width="86%"><span style="color: #477AC3; font-size:14px">Relyon Dealer Zone <strong>||</strong> Gateway to Leads, Billing, and other Advanced Services.</span></td>
              </tr>
            </table></td>
          </tr>
  ...
  <tr>
    <td valign="top" class="content"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="300" valign="top"><table width="40%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="20"></td>
          </tr>
          <tr>
            <td class="loginbox"><form id="passwordform" name="loginform" method="post" action="">
              <table width="100%" border="0" cellspacing="0" cellpadding="4">
                <tr bgcolor="#6295C6">
                  <td colspan="3"><font color="#FFFFFF">Password retrival tool</font></td>
                </tr>
                <tr>
                  <td height="20" colspan="3" align="center"><font color="#FF0000"><?php echo($message); ?></font></td>
                  </tr>
                <tr>
                  <td width="7%" height="20"></td>
                  <td width="30%">Login Name:</td>
                  <td width="63%"><input name="username" type="text" class="formfields" id="username" size="35" maxlength="50" /></td>
                </tr>
                <tr>
                  <td height="20"></td>
                  <td>Your email:</td>
                  <td><input name="email" type="text" class="formfields" id="email" size="35" maxlength="50" /></td>
                </tr>
                <tr>
                  <td height="20"></td>
                  <td></td>
  ...
  <input name="clear" type="reset" class="formbutton" id="clear" value="Clear" />
                ...
                <tr>
                  <td height="20"></td>
                  <td></td>
                  <td><div align="right"><a href="index.php">Back to Login page</a></div></td>
                </tr>
              </table>
                        </form>            </td>
          </tr>
