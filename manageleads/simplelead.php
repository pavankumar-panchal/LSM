...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="middle" bgcolor="#D2D8FB" class="contentheader"><table width="99%" border="0" align="center" cellpadding="4" cellspacing="0">
        <tr>
          <td>Update Lead <?php echo $userslno, $cookie_usertype; ?></td>
        </tr>
      </table></td>
  </tr>
  <tr>
                                ...
                                <tr>
                                  ...
                                  <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td width="17%"><strong><div id="displayrowcount" align="right"></div></strong></td>
                                        <td width="4%" align="right"><img src="../images/first.jpg"  alt="First" title="First"  onclick="getnextorpreviousvalue('first')"  style="cursor:pointer"/></td>
                                        <td width="5%" align="right"><img src="../images/previous.jpg"  onclick="getnextorpreviousvalue('previous')" style="cursor:pointer" title="Previous" alt="Previous"/></td>
                                        <td width="4%" align="left"><input type="hidden" name="hiddentypepn" id="hiddentypepn"  value=""/><input type="hidden" name="hiddenleadcount" id="hiddenleadcount"  value=""/>&nbsp;</td>
                                        <td width="5%" align="left"><img src="../images/next.jpg"  onclick="getnextorpreviousvalue('next')" style="cursor:pointer" title="Next" alt="Next"/></td>
                                        <td width="6%" align="left"><img src="../images/last.jpg"  alt="Last" title="Last"  onclick="getnextorpreviousvalue('last')" style="cursor:pointer"/></td>
                                      </tr>
                                      <tr>
                                        <td  colspan="12"  valign="top"><div id="tracker" style="display:block;">
...
 
                                                    ...
                                                    <td width="31%" valign="top"><select name="form_leadstatus" id="form_leadstatus" class="formfields">
                                                        ...
                                                        <option value="Requirement Does not Meet">Requirement Does not Meet</option>
                                                      </select>
                                                      <br><br>
                                                      <select name="form_subleadstatus" id="form_subleadstatus" class="formfields" style="display: none">
                                                      <option value="" selected="selected">--- Select Status ---</option>
                                                        <option value="Need PMS and HRMS">Need PMS and HRMS</option>
                                                        <option value="Need Cloud based Solution">Need Cloud based Solution</option>
                                                        <option value="Requirement does not match">Requirement does not match</option>
                                                        <option value="Need Payroll with T&A">Need Payroll with T&A</option>
                                                        <option value="Pricing Issue">Pricing Issue</option>
                                                        <option value="Executive not handled on-time">Executive not handled on-time</option>
                                                        <option value="Other">Other</option>
                                                        </select><br><br>
                                                      <textarea name='leadMeetRemarks' id='leadMeetRemarks' placeholder='Enter Remarks' style="display: none"></textarea> <br><br>
                            ...
                            <tr>
                              ...
                              <td colspan="2">&nbsp;
                                ...
                                <label>
                                  ...
                                  Both</label>
                                <input type="hidden" name="subselhiddenfield" id="subselhiddenfield" /></td>
                            </tr>
                            <tr>
						...
						?>
                            ...
                            <tr>
                              ...
                              <td colspan="2"><div align="center">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input name="excel" type="button" class="formbutton" id="excel" value="To Excel" onclick="filtering('excel');" <? echo $disabled;?> />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
          <td height="20px" colspan="4"><form id="toexcelform" name="toexcelform" action="" method="post"><div id="tabgroupleadgridc1" style="display:block;">
            ...
            <div id = 'tabgroupleadgridc2' style="display:none;">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #308ebc; border-top:none;">
                <tr class="headerline">
                  <td width="14%" ><strong>&nbsp;<span id="gridprocessnv"></span></strong></td>
            ...
            <div id="tabgroupleadgridc3" style="display:none;">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #308ebc; border-top:none;">
                <tr class="headerline">
                  ...
                  <td align="left"><div id="followupsduetoexcel" align="left">( <a style="cursor:pointer;" onclick="gridtoexcel('followupdue')" class="headerclass"><strong>Export to Excel</strong></a> )</div></td>
                </tr>
                <tr>
                  <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
            ...
            <div id="tabgroupleadgridc4" style="display:none;">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #308ebc; border-top:none;">
                <tr class="headerline">
                  <td width="14%"><div id = "followuptotaln" >&nbsp;</div></td>
                  <td width="15%" align="left"><div id="toexcellink" align="left">( <a style="cursor:pointer;" onclick="gridtoexcel('zerofollowup')" class="headerclass"><strong>Export to Excel</strong></a> )</div></td>
                  <td width="71%" align="left">&nbsp;</td>
                </tr>
                <tr>
                  <td colspan="4" ><div id="tabgroupgridn1" style="overflow:auto; height:260px; width:945px" align="center">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
