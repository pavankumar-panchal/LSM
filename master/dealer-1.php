...
<script src="../functions/dealermaster.js?dummy=<? echo (rand());?>" language="javascript"></script>
<!--[if lt IE 7]>
                ...
                <td><form id="dealerform" name="dealerform" method="post" action="">
                  <table width="100%" border="0" cellspacing="0" cellpadding="6">
                    <tr>
                      ...
                      <td width="302"><input name="form_companyname" type="text" class="formfields" id="form_companyname" value="<? echo ($company); ?>" size="50" maxlength="50" /></td>
                      <td width="69">Contact person:</td>
                      <td width="374"><input name="form_name" type="text" class="formfields" id="form_name" value="<? echo ($name); ?>" size="50" maxlength="50" /></td>
                    </tr>
                    <tr>
                      <td>Address:</td>
                      <td colspan="3"><input name="form_address" type="text" class="formfields" id="form_address" value="<? echo ($address); ?>" size="126" maxlength="200" /></td>
                      </tr>
                    <tr>
                      <td>State:</td>
                    ...
                    <tr>
                      <td>Phone:</td>
                      <td><input name="form_phone" type="text" class="formfields" id="form_phone" value="<? echo ($phone); ?>" size="50" maxlength="50" /></td>
                      <td>Cell:</td>
                    ...
                    <tr>
                      ...
                      <td>Website:</td>
                      <td><input name="form_website" type="text" class="formfields" id="form_website" value="<? echo ($website); ?>" size="50" maxlength="50" /></td>
                    </tr>
                    <tr>
                   ...
                   <option value="">Select A Branch</option>
                    ...
                    <tr>
                      ...
                      <td>&nbsp;</td>
                      <td><label>
                        <input type="checkbox" name="form_relyonexecutive" id="form_relyonexecutive" <? echo ($re);?> />
