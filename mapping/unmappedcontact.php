                  ...
                  <td><form id="ucform" name="ucform" method="post" action="">
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                          ...
                          <td width="302"><input name="form_companyname_bspp" type="text" class="formfields" id="form_companyname_bspp" value="<? echo($form_companyname_bspp); ?>" size="50" maxlength="50" /></td>
                          <td width="69">Contact person:</td>
                          <td width="374"><input name="form_name_bspp" type="text" class="formfields" id="form_name_bspp" size="50" maxlength="50" value="<? echo($form_name_bspp); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Address:</td>
                          <td colspan="3"><input name="form_address_bspp" type="text" class="formfields" id="form_address_bspp" size="126" maxlength="200" value="<? echo($form_address_bspp); ?>" /></td>
                        </tr>

                        <tr>
                          <td>Phone:</td>
                          <td><input name="form_phone_bspp" type="text" class="formfields" id="form_phone_bspp" size="50" maxlength="50" value="<? echo($form_phone_bspp); ?>" /></td>
                          <td>Cell:</td>
                          <td><input name="form_cell_bspp" type="text" class="formfields" id="form_cell_bspp" size="50" maxlength="50" value="<? echo($form_cell_bspp); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Email ID:</td>
                          <td><input name="form_email_bspp" type="text" class="formfields" id="form_email_bspp" size="50" maxlength="50" value="<? echo($form_email_bspp); ?>" /></td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                          <td width="147">Company Name: </td>
                          <td width="302"><input name="form_companyname_bsto" type="text" class="formfields" id="form_companyname_bsto" size="50" maxlength="50" value="<? echo($form_companyname_bsto); ?>" /></td>
                          <td width="69">Contact person:</td>
                          <td width="374"><input name="form_name_bsto" type="text" class="formfields" id="form_name_bsto" size="50" maxlength="50" value="<? echo($form_name_bsto); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Address:</td>
                          <td colspan="3"><input name="form_address_bsto" type="text" class="formfields" id="form_address_bsto" size="126" maxlength="200" value="<? echo($form_address_bsto); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Phone:</td>
                          <td><input name="form_phone_bsto" type="text" class="formfields" id="form_phone_bsto" size="50" maxlength="50" value="<? echo($form_phone_bsto); ?>" /></td>
                          <td>Cell:</td>
                          <td><input name="form_cell_bsto" type="text" class="formfields" id="form_cell_bsto" size="50" maxlength="50" value="<? echo($form_cell_bsto); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Email ID:</td>
                          <td><input name="form_email_bsto" type="text" class="formfields" id="form_email_bsto" size="50" maxlength="50" value="<? echo($form_email_bsto); ?>" /></td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                          <td width="147">Company Name: </td>
                          <td width="302"><input name="form_companyname_bothers" type="text" class="formfields" id="form_companyname_bothers" size="50" maxlength="50" value="<? echo($form_companyname_bothers); ?>" /></td>
                          <td width="69">Contact person:</td>
                          <td width="374"><input name="form_name_bothers" type="text" class="formfields" id="form_name_bothers" size="50" maxlength="50" value="<? echo($form_name_bothers); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Address:</td>
                          <td colspan="3"><input name="form_address_bothers" type="text" class="formfields" id="form_address_bothers" size="126" maxlength="200" value="<? echo($form_address_bothers); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Phone:</td>
                          <td><input name="form_phone_bothers" type="text" class="formfields" id="form_phone_bothers" size="50" maxlength="50" value="<? echo($form_phone_bothers); ?>" /></td>
                          <td>Cell:</td>
                          <td><input name="form_cell_bothers" type="text" class="formfields" id="form_cell_bothers" size="50" maxlength="50" value="<? echo($form_cell_bothers); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Email ID:</td>
                          <td><input name="form_email_bothers" type="text" class="formfields" id="form_email_bothers" size="50" maxlength="50" value="<? echo($form_email_bothers); ?>" /></td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                          <td width="147">Company Name: </td>
                          <td width="302"><input name="form_companyname_cspp" type="text" class="formfields" id="form_companyname_cspp" size="50" maxlength="50" value="<? echo($form_companyname_cspp); ?>" /></td>
                          <td width="69">Contact person:</td>
                          <td width="374"><input name="form_name_cspp" type="text" class="formfields" id="form_name_cspp" size="50" maxlength="50" value="<? echo($form_name_cspp); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Address:</td>
                          <td colspan="3"><input name="form_address_cspp" type="text" class="formfields" id="form_address_cspp" size="126" maxlength="200" value="<? echo($form_address_cspp); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Phone:</td>
                          <td><input name="form_phone_cspp" type="text" class="formfields" id="form_phone_cspp" size="50" maxlength="50" value="<? echo($form_phone_cspp); ?>" /></td>
                          <td>Cell:</td>
                          <td><input name="form_cell_cspp" type="text" class="formfields" id="form_cell_cspp" size="50" maxlength="50" value="<? echo($form_cell_cspp); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Email ID:</td>
                          <td><input name="form_email_cspp" type="text" class="formfields" id="form_email_cspp" size="50" maxlength="50" value="<? echo($form_email_cspp); ?>" /></td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                          <td width="147">Company Name: </td>
                          <td width="302"><input name="form_companyname_csto" type="text" class="formfields" id="form_companyname_csto" size="50" maxlength="50" value="<? echo($form_companyname_csto); ?>" /></td>
                          <td width="69">Contact person:</td>
                          <td width="374"><input name="form_name_csto" type="text" class="formfields" id="form_name_csto" size="50" maxlength="50" value="<? echo($form_name_csto); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Address:</td>
                          <td colspan="3"><input name="form_address_csto" type="text" class="formfields" id="form_address_csto" size="126" maxlength="200" value="<? echo($form_address_csto); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Phone:</td>
                          <td><input name="form_phone_csto" type="text" class="formfields" id="form_phone_csto" size="50" maxlength="50" value="<? echo($form_phone_csto); ?>" /></td>
                          <td>Cell:</td>
                          <td><input name="form_cell_csto" type="text" class="formfields" id="form_cell_csto" size="50" maxlength="50" value="<? echo($form_cell_csto); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Email ID:</td>
                          <td><input name="form_email_csto" type="text" class="formfields" id="form_email_csto" size="50" maxlength="50" value="<? echo($form_email_csto); ?>" /></td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                          <td width="147">Company Name: </td>
                          <td width="302"><input name="form_companyname_cothers" type="text" class="formfields" id="form_companyname_cothers" size="50" maxlength="50" value="<? echo($form_companyname_cothers); ?>" /></td>
                          <td width="69">Contact person:</td>
                          <td width="374"><input name="form_name_cothers" type="text" class="formfields" id="form_name_cothers" size="50" maxlength="50" value="<? echo($form_name_cothers); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Address:</td>
                          <td colspan="3"><input name="form_address_cothers" type="text" class="formfields" id="form_address_cothers" size="126" maxlength="200" value="<? echo($form_address_cothers); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Phone:</td>
                          <td><input name="form_phone_cothers" type="text" class="formfields" id="form_phone_cothers" size="50" maxlength="50" value="<? echo($form_phone_cothers); ?>" /></td>
                          <td>Cell:</td>
                          <td><input name="form_cell_cothers" type="text" class="formfields" id="form_cell_cothers" size="50" maxlength="50" value="<? echo($form_cell_cothers); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Email ID:</td>
                          <td><input name="form_email_cothers" type="text" class="formfields" id="form_email_cothers" size="50" maxlength="50" value="<? echo($form_email_cothers); ?>" /></td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                          <td width="147">Company Name: </td>
                          <td width="302"><input name="form_companyname_kspp" type="text" class="formfields" id="form_companyname_kspp" size="50" maxlength="50" value="<? echo($form_companyname_kspp); ?>" /></td>
                          <td width="69">Contact person:</td>
                          <td width="374"><input name="form_name_kspp" type="text" class="formfields" id="form_name_kspp" size="50" maxlength="50" value="<? echo($form_name_kspp); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Address:</td>
                          <td colspan="3"><input name="form_address_kspp" type="text" class="formfields" id="form_address_kspp" size="126" maxlength="200" value="<? echo($form_address_kspp); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Phone:</td>
                          <td><input name="form_phone_kspp" type="text" class="formfields" id="form_phone_kspp" size="50" maxlength="50" value="<? echo($form_phone_kspp); ?>" /></td>
                          <td>Cell:</td>
                          <td><input name="form_cell_kspp" type="text" class="formfields" id="form_cell_kspp" size="50" maxlength="50" value="<? echo($form_cell_kspp); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Email ID:</td>
                          <td><input name="form_email_kspp" type="text" class="formfields" id="form_email_kspp" size="50" maxlength="50" value="<? echo($form_email_kspp); ?>" /></td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                          <td width="147">Company Name: </td>
                          <td width="302"><input name="form_companyname_ksto" type="text" class="formfields" id="form_companyname_ksto" size="50" maxlength="50" value="<? echo($form_companyname_ksto); ?>" /></td>
                          <td width="69">Contact person:</td>
                          <td width="374"><input name="form_name_ksto" type="text" class="formfields" id="form_name_ksto" size="50" maxlength="50" value="<? echo($form_name_ksto); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Address:</td>
                          <td colspan="3"><input name="form_address_ksto" type="text" class="formfields" id="form_address_ksto" size="126" maxlength="200" value="<? echo($form_address_ksto); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Phone:</td>
                          <td><input name="form_phone_ksto" type="text" class="formfields" id="form_phone_ksto" size="50" maxlength="50" value="<? echo($form_phone_ksto); ?>" /></td>
                          <td>Cell:</td>
                          <td><input name="form_cell_ksto" type="text" class="formfields" id="form_cell_ksto" size="50" maxlength="50" value="<? echo($form_cell_ksto); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Email ID:</td>
                          <td><input name="form_email_ksto" type="text" class="formfields" id="form_email_ksto" size="50" maxlength="50" value="<? echo($form_email_ksto); ?>" /></td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                          <td width="147">Company Name: </td>
                          <td width="302"><input name="form_companyname_kothers" type="text" class="formfields" id="form_companyname_kothers" size="50" maxlength="50" value="<? echo($form_companyname_kothers); ?>" /></td>
                          <td width="69">Contact person:</td>
                          <td width="374"><input name="form_name_kothers" type="text" class="formfields" id="form_name_kothers" size="50" maxlength="50" value="<? echo($form_name_kothers); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Address:</td>
                          <td colspan="3"><input name="form_address_kothers" type="text" class="formfields" id="form_address_kothers" size="126" maxlength="200" value="<? echo($form_address_kothers); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Phone:</td>
                          <td><input name="form_phone_kothers" type="text" class="formfields" id="form_phone_kothers" size="50" maxlength="50" value="<? echo($form_phone_kothers); ?>" /></td>
                          <td>Cell:</td>
                          <td><input name="form_cell_kothers" type="text" class="formfields" id="form_cell_kothers" size="50" maxlength="50" value="<? echo($form_cell_kothers); ?>" /></td>
                        </tr>
                        <tr>
                          <td>Email ID:</td>
                          <td><input name="form_email_kothers" type="text" class="formfields" id="form_email_kothers" size="50" maxlength="50" value="<? echo($form_email_kothers); ?>" /></td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
