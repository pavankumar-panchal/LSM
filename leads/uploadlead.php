                ...
                <tr>
                  <td><form id="leaduploadform" name="leaduploadform" method="post" action="">
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                          <td>Address:</td>
                          <td colspan="4"><input name="form_address" type="text" class="formfields" id="form_address" size="126" maxlength="200" /></td>
                        </tr>
                        <tr>
                          <td>State:</td>
                        ...
                        <tr>
                          <td>STD Code:</td>
                          <td colspan="2"><input name="form_stdcode" type="text" class="formfields" id="form_stdcode" size="50" maxlength="50" /></td>
                          <td>Landline:</td>
                          <td><input name="form_phone" type="text" class="formfields" id="form_phone" size="50" maxlength="50" /></td>
                        </tr>
                        <tr>
                          <td>Cell:</td>
                          <td colspan="2"><input name="form_cell" type="text" class="formfields" id="form_cell" size="50" maxlength="50" /></td>
                          <td>Email ID:</td>
...
<!--                            <option value="STO Web Download">STO Web Download</option>-->
						...
						?>
                          ...
                          <td width="101" valign="middle"><div id="help" style=" display:none; padding-bottom:10px;" align="left"><img class="imageclass" onmouseout="hidetooltip()" onmouseover="generatedealertooltip()" src="../images/help-image.gif" /></div></td>
