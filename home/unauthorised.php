...
<title>LMS | Unauthorised access</title>
    ...
    <td valign="top" class="content"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="300" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
          <tr>
            <td>You are not authorised to visit this page. Please go back to <a href="index.php">Dashboard</a> or Navigate to desired through the menu.</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
