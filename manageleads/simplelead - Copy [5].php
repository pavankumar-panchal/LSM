                                ...
                                <tr>
                                  ...
                                  <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td width="4%" align="left"><input type="hidden" name="hiddentype" id="hiddentype"  value=""/><input type="hidden" name="hiddenleadcount" id="hiddenleadcount"  value=""/>&nbsp;</td>
						...
						?>
                              ...
                              <tr>
                                <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                                    <tr>
                                      <td width="11%">From Date : </td>
                                      <td colspan="2"><input name="filter_followupdate1" type="text" class="formfields" id="DPC_filter_followupdate1" size="20" maxlength="10" value="<?php echo($defaulttodate); ?>" disabled="disabled" style="width:50%" />
                                    ...
                                    <tr>
                                      <td>Date lookup:</td>
                                      <td width="18%"><label for="entereddatecheck"><input type="radio" name="datecheckfield" id="entereddatecheck" value="entereddatecheck" disabled="disabled"/>
Entered date</label></td>
                                      <td width="19%"><label for="nextfollowupdatecheck"><input type="radio" name="datecheckfield" id="nextfollowupdatecheck" value="nextfollowupdatecheck" checked="checked" disabled="disabled"/>
Next followup date</label></td>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                      <td>Entered By :</td>
                                      <td colspan="2"><select name="followedby" id="followedby" style="width:50%" disabled="disabled">
                                          <?php 
						echo($givenselect1);
						?>
                                        </select>
