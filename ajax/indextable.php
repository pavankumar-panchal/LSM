...
switch ($submittype) {
	...
	case "griddata":
		if (lmsgetcookie('lmsusername') <> '' && lmsgetcookie('lmsusersort') <> '') {
			...
			if ($slnocount == '0') {
				...
				$grid .= '<tr class="gridheader"><td nowrap="nowrap"  class="tdborderlead" style = "border-top:none;">Sl No</td><td nowrap="nowrap"  class="tdborderlead" style = "border-top:none;">Followup ID</td><td nowrap="nowrap"  class="tdborderlead" style = "border-top:none;" >Followup </td><td nowrap="nowrap"  class="tdborderlead" style = "border-top:none;">Product</td><td nowrap="nowrap"  class="tdborderlead" style = "border-top:none;">Company</td><td nowrap="nowrap"  class="tdborderlead" style = "border-top:none;">Contact</td><td nowrap="nowrap"  class="tdborderlead" style = "border-top:none;">Landline</td><td nowrap="nowrap"  class="tdborderlead" style = "border-top:none;">Cell</td><td nowrap="nowrap"  class="tdborderlead" style = "border-top:none;">Email ID</td><td nowrap="nowrap" class="tdborderlead" style = "border-top:none;">District<td nowrap="nowrap"  class="tdborderlead" style = "border-top:none;">State</td><td nowrap="nowrap"  class="tdborderlead" style = "border-top:none;">Dealer</td><td nowrap="nowrap" class="tdborderlead" style = "border-top:none;">Manager</td></tr>';
			}
	...
	case "filter":
		...
		/*$lastfollowupcheckpiece = "AND (lms_followup.followupstatus = 'PENDING' or 
					   lms_followup.followupstatus = 'DONE' or  lms_followup.followupstatus is null)";*/
		/*$lastfollowupcheckpiece = "AND (lms_followup.followupstatus = 'PENDING' or 
					   lms_followup.followupstatus is null)";*/
		...
		if ($filter_followupdate1 == 'dontconsider') {
			...
			if ($followupcheck == 'followuppending') {
				...
				/* $followuppiece = "AND lms_followup.followupdate >= '".changedateformat($filter_followupdate1)."' AND 
			...
			if (checkdateformat($fromdate) && checkdateformat($todate) && ((datenumeric($todate) - datenumeric($fromdate)) >= 0)) {
				...
				switch ($cookie_usertype) {
					...
					case "Sub Admin":
						...
						$query = "select distinct leads.id, leads.leaddatetime, products.productname, leads.company, 
							  leads.name, leads.phone, leads.cell, leads.emailid, regions.distname, regions.statename, 
							  dealers.dlrcompanyname, lms_managers.mgrname from leads  left join lms_followup on leads.id = 
							  lms_followup.leadid join dealers on leads.dealerid = dealers.id join lms_managers on 
							  lms_managers.id = dealers.managerid join products on products.id = leads.productid 
							  join regions on leads.regionid = regions.subdistcode 
							  where " . $datetimepiece . " " . $terminatedstatuspiece . " 
							  " . $followuppiece . "  " . $dealerpiece . " " . $productpiece . " " . $leaduploadedby . " " .
							$leadstatuspiece . "  " . $searchpiece . " " . $sourcepiece . " " . $leadsourcelist . " " . $leadsubstatuspiece . " ORDER BY leads.id DESC";
					...
					case "Reporting Authority":
						...
						$query = "select distinct leads.id, leads.leaddatetime, products.productname, leads.company,leads.name,leads.phone,leads.cell, leads.emailid, regions.distname, regions.statename, dealers.dlrcompanyname, lms_managers.mgrname  from leads left join lms_followup on leads.id = lms_followup.leadid left join dealers on dealers.id = leads.dealerid left join lms_managers on lms_managers.id=dealers.managerid left join products on products.id = leads.productid join regions on leads.regionid = regions.subdistcode left join lms_users on lms_users.referenceid = lms_managers.id where  " . $datetimepiece . " " . $terminatedstatuspiece . " " . $followuppiece . " " . $dealerpiece . " " . $productpiece . " " . $leaduploadedby . " " . $leadstatuspiece . " AND lms_users.type = 'Reporting Authority' " . $branchpiecejoin . " " . $searchpiece . " " . $sourcepiece . " " . $leadsourcelist . " " . $leadsubstatuspiece . "  ORDER BY leads.id DESC";
						if ($cookie_username == "srinivasan")
							$query = "select distinct leads.id, leads.leaddatetime, products.productname, leads.company,leads.name,leads.phone,leads.cell, leads.emailid, regions.distname, regions.statename, dealers.dlrcompanyname, lms_managers.mgrname  from leads left join lms_followup on leads.id = lms_followup.leadid left join dealers on dealers.id = leads.dealerid left join lms_managers on lms_managers.id=dealers.managerid left join products on products.id = leads.productid join regions on leads.regionid = regions.subdistcode left join lms_users on lms_users.referenceid = lms_managers.id where  " . $datetimepiece . " " . $terminatedstatuspiece . " " . $followuppiece . " " . $dealerpiece . " " . $productpiece . " " . $leaduploadedby . " " . $leadstatuspiece . " AND lms_users.type = 'Reporting Authority' AND (lms_users.username = 'srinivasan' or  lms_users.username = 'nagaraj') " . $searchpiece . " " . $sourcepiece . " " . $leadsourcelist . " " . $leadsubstatuspiece . " ORDER BY leads.id DESC";
						break;
					case "Dealer":
						$query = "select distinct leads.id, leads.leaddatetime, products.productname, leads.company,leads.name,leads.phone,leads.cell, leads.emailid,regions.distname, regions.statename,dealers.dlrcompanyname, lms_managers.mgrname  from leads left join lms_followup on leads.id = lms_followup.leadid left join dealers on dealers.id = leads.dealerid left join lms_managers on lms_managers.id=dealers.managerid left join products on products.id = leads.productid join regions on leads.regionid = regions.subdistcode left join lms_users on lms_users.referenceid = dealers.id where  " . $datetimepiece . " " . $terminatedstatuspiece . " " . $followuppiece . " " . $dealerpiece . " " . $productpiece . " " . $leaduploadedby . " " . $leadstatuspiece . " and lms_users.type = 'Dealer' and lms_users.username = '" . $cookie_username . "' " . $searchpiece . " " . $sourcepiece . " " . $leadsourcelist . " " . $leadsubstatuspiece . " ORDER BY leads.id DESC";

						break;
					case "Dealer Member":
						$query = "select distinct leads.id, leads.leaddatetime, products.productname, leads.company,leads.name,leads.phone,leads.cell, leads.emailid,regions.distname, regions.statename,dealers.dlrcompanyname, lms_managers.mgrname from leads left join lms_followup on leads.id = lms_followup.leadid left join dealers on dealers.id = leads.dealerid left join lms_dlrmembers on leads.dlrmbrid = lms_dlrmembers.dlrmbrid  left join  lms_managers on lms_managers.id=dealers.managerid left join products on products.id = leads.productid join regions on leads.regionid = regions.subdistcode left join lms_users on lms_users.referenceid = lms_dlrmembers.dlrmbrid where  " . $datetimepiece . " " . $terminatedstatuspiece . "  " . $terminatedstatuspiece . " " . $followuppiece . " " . $dealerpiece . " " . $productpiece . " " . $leaduploadedby . " " . $leadstatuspiece . " " . $leadsubstatuspiece . " and lms_users.type = 'Dealer Member' and lms_users.username = '" . $cookie_username . "' " . $searchpiece . " " . $sourcepiece . " " . $leadsourcelist . " ORDER BY leads.id DESC";
						break;
				} //echo($query);exit;
				if ($slnocount == '0') {
					$grid = '<table width="100%" border="0" bordercolor="#ffffff" cellspacing="0" cellpadding="2" id="gridtablelead">';
					//Write the header Row of the table
					$grid .= '<tr class="gridheader"><td nowrap="nowrap"  class="tdborderlead">Sl No</td><td nowrap="nowrap"  class="tdborderlead">Followup ID</td><td nowrap="nowrap"  class="tdborderlead">Followup Date</td><td nowrap="nowrap"  class="tdborderlead">Product</td><td nowrap="nowrap"  class="tdborderlead">Company</td><td nowrap="nowrap"  class="tdborderlead">Contact</td><td nowrap="nowrap"  class="tdborderlead">Landline</td><td nowrap="nowrap"  class="tdborderlead">Cell</td><td nowrap="nowrap"  class="tdborderlead">Email ID</td><td nowrap="nowrap"  class="tdborderlead">District<td nowrap="nowrap"  class="tdborderlead">State</td><td nowrap="nowrap"  class="tdborderlead">Dealer</td><td nowrap="nowrap"  class="tdborderlead">Manager</td></tr><tbody>';
				}
				$result = runmysqlquery($query);
				$fetchresultcount = mysqli_num_rows($result);
				$addlimit = " LIMIT " . $startlimit . "," . $limit . ";";
	...
	case "save":
		if (lmsgetcookie('lmsusername') <> '' && lmsgetcookie('lmsusersort') <> '') {
			...
			//added on 30-07-2020
			$form_leadMeetRemarks = $_POST['form_leadMeetRemarks'];
			$form_subleadstatus = $_POST['form_subleadstatus'];
			...
			$query = "update leads set leadstatus = '" . $form_leadstatus . "',leadsubstatus = '" . $form_subleadstatus . "', lastupdateddate = '" . $lastupdateddate . ' ' . $lastupdatetime . "', lastupdatedby = '" . $lastupdatedby . "',leadstatusremarks='" . addslashes($form_leadMeetRemarks) . "' WHERE id = '" . $form_recid . "'";
			$result = runmysqlquery($query);
		...
		if (lmsgetcookie('lmsusername') <> '' && lmsgetcookie('lmsusersort') <> '') {
			...
			if ($output == "") {
				if ($followupdate == "" && $followuptime == "") {
					...
					$query1 = "SELECT distinct t1.id as pid FROM leads t1 INNER JOIN leads t2 WHERE t1.id > t2.id AND t1.cell = t2.cell AND t1.productid = t2.productid and t1.productid='$product' and t1.cell='$cell'";
					$result1 = runmysqlquery($query1);
					while ($fetch1 = mysqli_fetch_array($result1)) {
						$row1[] = $row['pid'];
					}
					$duplicates = in_array($leadid, $row1);
					//echo $result1['pid'];
					//print_r($fetch1);
					// exit;
					if ($result['leadstatus'] <> "Order Closed" && $result['leadstatus'] <> "Registered User" && $result['leadstatus'] <> "Fake Enquiry" && $result['leadstatus'] <> "Not Interested" && $duplicates == false)
	...
	case "transferlead":
		...
		if ($cookie_usertype == 'Admin' || $cookie_usertype == 'Sub Admin' || $cookie_usertype == 'Reporting Authority' || $userslno == '1069') {
		...
		} else if ($cookie_usertype == 'Dealer' && $userslno != '1069') {
			$transferdate = datetimelocal("Y-m-d");
			$transfertime = datetimelocal("H:i:s");
			$cookie_username = lmsgetcookie('lmsusername');
	...
	case 'notviewed':
		if (lmsgetcookie('lmsusername') <> '' && lmsgetcookie('lmsusersort') <> '') {
			...
			switch ($cookie_usertype) {
				case 'Admin':
				case 'Sub Admin':
					$query = "select distinct leads.id, leads.leaddatetime, products.productname, leads.company,leads.name,leads.phone,leads.cell, leads.emailid,regions.distname, regions.statename,dealers.dlrcompanyname,lms_managers.mgrname from leads left join dealers on dealers.id =leads.dealerid  left join lms_managers on lms_managers.id = dealers.managerid left join products on products.id = leads.productid left join regions on leads.regionid = regions.subdistcode where leads.leadstatus <> 'Fake Enquiry' and leads.leadstatus <> 'Not Interested' and leads.leadstatus <> 'Registered User' and leads.leadstatus <> 'Order Closed' and leads.leadstatus = 'Not Viewed' and leads.dealerid <> '999999' " . $datepiece . " order by leads.id DESC";
					break;
				case 'Reporting Authority':
					...
					$query = "select distinct leads.id, leads.leaddatetime, products.productname, leads.company,leads.name,leads.phone,leads.cell, leads.emailid,regions.distname, regions.statename,dealers.dlrcompanyname,lms_managers.mgrname from leads left join dealers on dealers.id =leads.dealerid  left join lms_managers on lms_managers.id = dealers.managerid left join products on products.id = leads.productid left join regions on leads.regionid = regions.subdistcode left join lms_users on lms_users.referenceid = lms_managers.id where leads.leadstatus <> 'Fake Enquiry' and leads.leadstatus <> 'Not Interested' and leads.leadstatus <> 'Registered User' and leads.leadstatus <> 'Order Closed' and leads.leadstatus = 'Not Viewed'  and leads.dealerid <> '999999' and lms_users.type = 'Reporting Authority' " . $datepiece . $branchpiecejoin . " order by leads.id DESC";
					//echo($query);exit;
					break;

				case 'Dealer':
					$query = "select distinct leads.id, leads.leaddatetime, products.productname, leads.company,leads.name,leads.phone,leads.cell, leads.emailid,regions.distname, regions.statename,dealers.dlrcompanyname,lms_managers.mgrname from leads left join dealers on dealers.id =leads.dealerid  left join lms_managers on lms_managers.id = dealers.managerid left join products on products.id = leads.productid left join regions on leads.regionid = regions.subdistcode left join lms_users on lms_users.referenceid = dealers.id  where leads.leadstatus <> 'Fake Enquiry' and leads.leadstatus <> 'Not Interested' and leads.leadstatus <> 'Registered User' and leads.leadstatus <> 'Order Closed' and leads.leadstatus = 'Not Viewed'  and leads.dealerid <> '999999' and lms_users.username = '" . $cookie_username . "' and lms_users.type = 'Dealer' " . $datepiece . " order by leads.id DESC";
					break;

				case 'Dealer Member':
					$query = "select distinct leads.id, leads.leaddatetime, products.productname, leads.company,leads.name,leads.phone,leads.cell, leads.emailid,regions.distname, regions.statename,dealers.dlrcompanyname,lms_managers.mgrname from leads left join dealers on dealers.id =leads.dealerid left join lms_managers on lms_managers.id = dealers.managerid left join products on products.id = leads.productid left join regions on leads.regionid = regions.subdistcode left join lms_users on lms_users.referenceid = leads.dlrmbrid left join lms_dlrmembers on lms_dlrmembers.dealerid = leads.dealerid  where leads.leadstatus <> 'Fake Enquiry' and leads.leadstatus <> 'Not Interested' and leads.leadstatus <> 'Registered User' and leads.leadstatus <> 'Order Closed' and leads.leadstatus = 'Not Viewed'  and leads.dealerid <> '999999' and lms_users.username = '" . $cookie_username . "' and lms_users.type = 'Dealer Member' " . $datepiece . " order by leads.id DESC";
					break;
	...
	case 'otherleads':
		if (lmsgetcookie('lmsusername') <> '' && lmsgetcookie('lmsusersort') <> '') {
			...
			if ($slnocount == '0') {
				$grid = '<table width="100%" border="0" bordercolor="#ffffff" cellspacing="0" cellpadding="2" id="gridtablelead">';
				//Write the header Row of the table
				$grid .= '<tr class="gridheader"><td nowrap="nowrap"  class="tdborderlead">Sl No</td><td nowrap="nowrap"  class="tdborderlead">Followup ID</td><td nowrap="nowrap"  class="tdborderlead">Followup Date</td><td nowrap="nowrap"  class="tdborderlead">Product</td><td nowrap="nowrap"  class="tdborderlead">Company</td><td nowrap="nowrap"  class="tdborderlead">Dealer</td></tr><tbody>';
			}
			$result = runmysqlquery($query);
			$fetchresultcount = mysqli_num_rows($result);
			$addlimit = " LIMIT " . $startlimit . "," . $limit . "; ";
