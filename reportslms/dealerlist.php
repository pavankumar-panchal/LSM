        ...
        <td height="300" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td style="border:solid 1px #999999"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                  <td><form id="filterform" name="filterform" onsubmit="return false;" autocomplete = "off" method="post" action="dealerlisttoexcel.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                      <tr>
                        <td width="9%">Search For:</td>
                        <td width="22%"><input name="searchcriteria" type="text" class="formfields" id="searchcriteria" size="30" maxlength="30" />
                            <input type="hidden" name="hiddensearchcriteria" id="hiddensearchcriteria" /></td>
                        <td width="2%">In:</td>
                        <td width="67%"><table width="100%" border="0" cellspacing="0" cellpadding="4" style="border:1px solid #CCCCCC;">
                          <tr>
                            <td><span>
                            <label>
