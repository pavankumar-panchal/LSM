...
<script src="../functions/mapping1.js?dummy=<?php echo (rand());?>" language="javascript"></script>
<!--[if lt IE 7]>
...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><strong>Select a Dealer and Proceed:</strong></td>
      </tr>
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="6">
            ...
            <tr>
              <td colspan="2"><div id="dealerdisplay" style="font-size:16px; color:#FF9900; font-weight:bold">Select a Dealer name below</div></td>
            </tr>
            <tr>
              <td width="65%" id="msg_box">&nbsp;</td>
              <td width="35%"><div id="proceedlink" align="center"><a href="#"><strong>Proceed &gt;&gt;</strong></a></div></td>
            </tr>
        </table></td>
      </tr>
    </table></td>
  ...
  <tr>
    <td style="border:solid 1px #999999"><table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td><form id="filter" name="filter" method="post" action="" onsubmit="return false;" autocomplete = "off">
            <table width="100%" border="0" cellspacing="0" cellpadding="6">
              <tr>
                <td width="27%"><strong>Search</strong>:
                  <input name="searchcriteria" type="text" class="formfields" id="searchcriteria"  size="30" maxlength="30" /><input type="hidden" name="srchhiddenfield" value="" id="srchhiddenfield"/><input type="hidden" name="subselhiddenfield" value="" id="subselhiddenfield"/></td>
                <td colspan="2"><strong>Search For</strong>:
                  <label>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="24%"><strong>Dealer List:</strong><span id="gridprocess"></span></td>
      ...
      <tr>
        <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
             <td colspan="3" style="border:1px solid #333333;"><div id="tabgroupgridc1" style="overflow:auto; height:250px; width:940px;  padding:2px;" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
