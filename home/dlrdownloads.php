								...
								<tr>
									<td height="54">
										<table width="99%" border="0" align="center" cellpadding="2" cellspacing="0">
											<tr>
												<td width="14%"><a href="http://lms.relyonsoft.net"><img
															src="../images/lms-logo.gif" alt="Lead Management Software"
									...
									<td style="border:#666666 1px solid">
										<table width="100%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr>
												...
												<td valign="top" bgcolor="#006699">
													<div align="center">
														<font color="#FFFFFF"><strong>Setups</strong></font>
													</div>
												</td>
												<td valign="top" bgcolor="#006699">
													<div align="center">
														<font color="#FFFFFF"><strong>Utilities</strong></font>
													</div>
												</td>
												<td valign="top" bgcolor="#006699">
													<div align="center">
														<font color="#FFFFFF"><strong>Documents</strong></font>
													</div>
												</td>
												<td valign="top" bgcolor="#006699">
													<div align="center">
														<font color="#FFFFFF"><strong>Marketing Contents</strong></font>
													</div>
												</td>
											</tr>
											<tr>
												<td width="20%" height="39" valign="top" bgcolor="#F7D0CE">
													<table width="100%" border="0" cellspacing="0" cellpadding="4">
														<tr>
															<td bgcolor="#FFFFFF"><img src="../images/spp.gif"
																	alt="Saral PayPack" width="175" height="42" /></td>
														</tr>
													</table>
												</td>
												<td width="20%" valign="top" bgcolor="#F7D0CE">
													<?php
													$query = "";
											...
											<tr>
												<td height="55" valign="top" bgcolor="#B5C7F0">
													<table width="100%" border="0" cellspacing="0" cellpadding="4">
														<tr>
															<td bgcolor="#FFFFFF"><img src="../images/stologo.gif"
																	alt="Saral TaxOffice" width="175" height="62" />
															</td>
														</tr>
													</table>
												</td>
											...
											<tr>
												<td height="45" valign="top" bgcolor="#B9FFCF">
													<table width="100%" border="0" cellspacing="0" cellpadding="4">
														<tr>
															<td bgcolor="#FFFFFF"><img src="../images/tds-logo.png"
																	alt="Saral TDS" width="175" height="48" /></td>
														</tr>
													</table>
												</td>
												<td valign="top" bgcolor="#B9FFCF">
													<?php
													$query = "";
											...
											<tr>
												<td height="55" valign="top" bgcolor="#FFFF97">
													<table width="100%" border="0" cellspacing="0" cellpadding="4">
														<tr>
											...
											<tr>
												<td height="61" valign="top" bgcolor="#CCCCCC">
													<table width="100%" border="0" cellspacing="0" cellpadding="4">
														<tr>
						...
						<td>
							<table width="100%" border="0" cellpadding="4" cellspacing="0" class="footer">
								<tr>
									...
									<td width="50%">
										<div align="right"><a href="http://www.relyonsoft.com"
												target="_blank">www.relyonsoft.com</a> | <a
												href="http://www.saraltaxoffice.com"
												target="_blank">www.saraltaxoffice.com</a> | <a
												href="http://www.saralpaypack.com"
												target="_blank">www.saralpaypack.com</a> | <a
												href="http://www.saraltds.com" target="_blank">www.saraltds.com</a>
										</div>
									</td>
								</tr>
							</table>
