...
function generatedealertooltip()
{
  if($("#form_dealer").val() == '')
  	return false;
  else
  {
	var passdata = "&submittype=dealertooltip&dealerid=" +$("#form_dealer").val()+"&dummy=" + Math.floor(Math.random()*100032680100);
	var queryString = "../ajax/leadupload.php";
	tipobj.style.display="block";
	tipobj.innerHTML = processing();
	enabletip=true;
   // return false;
	ajaxobjext37 = $.ajax(
	{
