                      ...
                      <tr>
                        <td>
                          <form id="filterform" name="filterform" onsubmit="return false;" autocomplete="off"
                            method="post" action="lead-source-xl.php">
                            <table width="100%" border="0" cellspacing="0" cellpadding="6">
                              <tr>
                                <td width="11%">From Date : </td>
                                <td width="38%"><input name="fromdate" type="text" class="formfields" id="DPC_fromdate"
                                    size="25" maxlength="10" value="<?php echo ($date); ?>" readonly="readonly" /></td>
                                <td width="11%">To Date : </td>
                                <td width="40%"><input name="todate" type="text" class="formfields" id="DPC_todate"
                                    size="25" maxlength="10" value="<?php echo ($defaulttodate); ?>"
                                ...
                                <td colspan="2">
                                  <div align="center">
                                    <input name="excel" type="button" class="formbutton" id="excel" value="To Excel"
                                      onclick="filtering();" <? echo $disabled; ?> </div>
                                </td>
                              </tr>
                            </table>
                          </form>
