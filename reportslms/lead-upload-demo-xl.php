...
join (select count(productid = '1' or NULL) AS sppleads,count(productid = '5' or productid = '7' or productid = '12' or NULL) as tdsleads,count(productid = '21' or NULL) as sitleads,count(productid = '17' or NULL) as stoleads,count(productid = '22' or NULL) as sacleads,count(productid <> '1' and productid <> '21' and productid <> '17' and productid <> '22' and productid <> '5' and productid <> '7' and productid <> '12' or NULL) as otherleads from leads where (leadstatus like '%Demo Given%' OR  leadstatus like '%Order Closed%') AND source = 'Product Download' AND " . $datetimepiece . ") AS webleads limit 1)
...
left join (select leaduploadedby,count(productid = '1' or NULL) AS sppleads,count(productid = '5' or productid = '7' or productid = '12' or NULL) as tdsleads,count(productid = '21' or NULL) as sitleads,count(productid = '17' or NULL) as stoleads,count(productid = '22' or NULL) as sacleads,count(productid <> '1' and productid <> '21' and productid <> '17' and productid <> '22' and productid <> '5' and productid <> '7' and productid <> '12' or NULL) as otherleads from leads where (leadstatus like '%Demo Given%'  OR  leadstatus like '%Order Closed%') AND
...
left join (select leaduploadedby,count(productid = '1' or NULL) AS sppleads,count(productid = '5' or productid = '7' or productid = '12' or NULL) as tdsleads,count(productid = '21' or NULL) as sitleads,count(productid = '17' or NULL) as stoleads,count(productid = '22' or NULL) as sacleads,count(productid <> '1' and productid <> '21' and productid <> '17' and productid <> '22' and productid <> '5' and productid <> '7' and productid <> '12' or NULL) as otherleads from leads where (leadstatus like '%Demo Given%' OR leadstatus like '%Order Closed%') AND" . $datetimepiece . " group by leaduploadedby) AS dlrleads on lms_users.id = dlrleads.leaduploadedby where lms_users.username = '" . $cookie_username . "' group by dealers.dlrcompanyname order by dealers.id)";
		...
		$mySheet->getStyle('A1:L1')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
		$mySheet->getStyle('A2:L2')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
