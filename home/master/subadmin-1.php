...
<script src="../functions/subadminmaster.js?dummy=<?php echo (rand());?>" language="javascript"></script>
<script>
function dislogin()
{
                  ...
                  <td><form id="subadminform" name="subadminform" method="post" action="">
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        <tr>
                          ...
                          <td width="374"><input name="form_email" type="text" class="formfields" id="form_email" value="<?php echo ($email); ?>" size="50" maxlength="50" /></td>
                        </tr>
                        ...
                        <tr>
                          <td>Cell :</td>
                          <td><input name="form_cell" type="text"  class="formfields" id="form_cell" value="<?php echo ($cell); ?>" size="50" /></td>
                          <td>&nbsp;</td>
