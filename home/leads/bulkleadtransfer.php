...
<title>LMS | Bulk Lead Transfer</title>
...
<script src="../functions/bulkleadtransfer.js?dummy=<?php echo (rand());?>" language="javascript"></script>
...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                                  <tr>
                                    ...
                                    <td width="37%"><input name="filter_followupdate1" type="text" class="formfields" id="DPC_filter_followupdate1" size="20" maxlength="10" value="<?php echo($defaulttodate); ?>" disabled="disabled" style="width:50%"/>
                                      <input name="filter_followupdate1hdn" type="hidden" class="formfields" id="filter_followupdate1hdn" value="" readonly="readonly"/></td>
                                    <td width="13%">To Date : </td>
  ...
  <tr>
    ...
    <td  width="60%" id="totalleads" style="font-weight:bold">&nbsp;</td>
              ...
              <tr>
                <td colspan="3">&nbsp;<strong>3. Transfer Selected Leads</strong></td>
              </tr>
              <tr>
                <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="5" style="border:1px solid #CCCCCC;">
                    <tr>
                      <td height="25px" colspan="2"><strong>Total number of leads Selected is</strong>&nbsp;&nbsp;<span id="selectedleadscount">0.</span></td>
                      <td height="25px"><strong>Transfer Selected Leads to Dealer :&nbsp;</strong>
                        <select name="todealer" id="todealer" style="width:35%">
                          <?php echo($dealerselect1);?>
                        </select>
                        <input name="hiddenid" type="hidden" id="hiddenid" /></td>
                    </tr>
                    <tr>
                      <td width="32%"  height="30px"><div id="progressbar" style="display:none; position:relative; top:+5px;" >
                      ...
                      <td width="16%"><span id="abort" onclick = "abortleadtransferajaxprocess()" class="abort" style="display:none">(STOP)</span></td>
                      <td width="52%" align="center"  height="50px" ><input type="submit" name="transferlead" id="transferlead" value="Transfer" class="formbutton" onclick="transferleads();" /></td>
                    </tr>
                    <tr>
                      <td colspan="3" height="30px"><div id="messagebox"></div></td>
                    </tr>
                </table></td>
              </tr>
            </table></td>
