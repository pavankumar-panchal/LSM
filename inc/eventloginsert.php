...
if ((lmsgetcookie('applicationid') == '8616153779973246153879') && (lmsgetcookie('sessionkind') <> false) && (lmsgetcookie('lmsusername') <> false) && (lmsgetcookie('lmsusersort') <> false) && (lmsgetcookie('lmslastlogindate') <> false)) {
		...
		case 'reportslms': {
				switch ($pagelinkvalue1) {
					...
					case 'lead-upload':
						$pagetextvalue = '74';
						break;
					case 'dlr-delay-leads':
						$pagetextvalue = '75';
						break;
					case 'demogivenstats':
						$pagetextvalue = '76';
						break;
					case 'leadstatuschart':
						$pagetextvalue = '77';
						break;
				}
			}
	...
	$eventquery = "INSERT INTO lms_logs_event (userid, system, eventtype, eventdatetime, logindate) VALUES ('$userslno', '" . $_SERVER['REMOTE_ADDR'] . "', '$pagetextvalue', '" . datetimelocal("Y-m-d") . ' ' . datetimelocal("H:i:s") . "', NOW());";
	$eventresult = runmysqlquery_log($eventquery);
