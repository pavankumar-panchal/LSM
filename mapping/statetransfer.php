...
<script src="../functions/statetransfermapping.js?dummy=<? echo (rand());?>" language="javascript"></script>
<!--[if lt IE 7]>
              ...
              <tr>
                ...
                <td>
                   <table width="100%" border="0" cellspacing="0" cellpadding="6">
                    <tr>
                      <td width="33%" align="left"><div id="dealerdisplay" style="font-weight:bold">Select a Dealer Name below :</div></td>
                       <td width="33%" align="left"><div id="dealerdisplay" class="statenamedlr"></div></td>
                       <td width="33%" align="left"><div id="dealerdisplay" class="categorystate"></div></td>
                    </tr>
                    </table>
                    </td>
                    </tr>
                    ...
                    <tr>
                      <td style="border:#666666 0px solid" ><table width="100%" border="0" cellspacing="0" cellpadding="6">
                          <tr>
                            <td width="33%"><select name="form_dlrlist" class="formfields" id="form_dlrlist" style="width:245px;" onchange="griddata();load_state();document.getElementById('msg_box').innerHTML='';document.getElementById('rd_box').innerHTML='';">
                                <?php dlrname();?>
                              </select></td>
                            <td width="33%"><div id="statename" style="display:none"><select name="form_state" class="formfields" id="form_state" style="width:250px;" onchange="state();load_category();">
                                <option name="sel_dlr" value="all"> Select Dealer Name First </option>
                              </select></div></td>
                              <td width="33%"><div id="categoryname" style="display:none">
                            <select name="form_category" class="formfields" id="form_category" style="width:250px;" onchange="category();">
                                <option name="sel_category" value="all"> Select State First </option>
                              </select></div></td>  
                          </tr>
                          <tr>
                            <td width="30%" id="rd_box" style="color:#F8051E">&nbsp;</td>
              ...
              <tr>
                <td><div id="dlrtransfer" style="display:none;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                      <tr>
                        <td><div id="dealerdisplay">Data Transfer To :</div></td>
                      </tr>
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="6">
                            <tr>
                              <td colspan="2"><select name="form_dlrlist1" class="formfields" id="form_dlrlist1" style="width:250px;" onchange="gridlist();document.getElementById('msg_box').innerHTML='';">
                                  <?php dlrnameactive();?>
                                </select></td>
                            </tr>
                            <tr>
