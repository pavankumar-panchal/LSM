          ...
          <tr>
            <td height="300" valign="top">
              <table width="100%" border="0" cellspacing="0" cellpadding="4">
                <tr>
                  <td><strong>
                      <font style="font-size:16px" color="#0099CC">Welcome
                        <?php echo ($sadname); ?>!!
                      </font>
                    </strong></td>
                </tr>
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="2">
                            <tr>
                              <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="100%" valign="top" style="border:solid 1px #999999">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                        <tr>
                                          <td bgcolor="#0099CC"><strong>
                                              <font color="#FFFFFF">Total Number of leads generated today!!</font>
                                            </strong> </td>
                                        </tr>
                                        <tr>
                                          <td height="20" valign="top" class="dashboard-box">Total Number of Leads:
                                            <?php echo ($todayleadcount_total); ?><br />
                                            <font color="#FF0000">CSD Region:
                                              <?php echo ($todayleadcount_csd); ?><br />
                                            </font>
                                            <font color="#006600">KKG Region:
                                              <?php echo ($todayleadcount_kkg); ?>
                                            </font><br />
                                            <font color="#0000FF">Bangalore:
                                              <?php echo ($todayleadcount_blr); ?>
                                            </font><br />
                                            <br />
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td
                                                  title="<?php echo (number_format(($todayleadcount_csd * 100) / $todayleadcount_total)); ?>%"
                                                  width="<?php echo (($todayleadcount_csd * 100) / $todayleadcount_total); ?>%"
                                                  height="20" bgcolor="#FF0000"></td>
                                                <td
                                                  title="<?php echo (number_format(($todayleadcount_kkg * 100) / $todayleadcount_total)); ?>%"
                                                  width="<?php echo (($todayleadcount_kkg * 100) / $todayleadcount_total); ?>%"
                                                  bgcolor="#006600"></td>
                                                <td
                                                  title="<?php echo (number_format(($todayleadcount_blr * 100) / $todayleadcount_total)); ?>%"
                                                  width="<?php echo (($todayleadcount_blr * 100) / $todayleadcount_total); ?>%"
                                                  bgcolor="#0000FF"></td>
                                              </tr>
                                              <tr>
                                                <td colspan="3">&nbsp;</td>
                            ...
                            <tr>
                              <td width="100%" valign="top" style="border:solid 1px #999999">
                                <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                  <tr>
                                    <td bgcolor="#0099CC"><strong>
                                        <font color="#FFFFFF">User Profile</font>
                                      </strong></td>
                                  </tr>
                                  <tr>
                                    <td valign="top" class="dashboard-box"><strong>
                                        <font color="#0099CC">
                                          <?php echo ($sadname); ?>
                                        </font>
                                      </strong><br />
                                      Email:
                                      <?php echo ($sademail); ?><br />
                                    </td>
                                  </tr>
                                  <tr>
                                    <td bgcolor="#0099CC"><strong>
                                  ...
                                  <tr>
                                    <td>
                                      <div>
                                        <ul>
                                          <li><a href="./dlrdownloads.php"
                                              onmouseover="ddrivetip('You can download Relyon setups, updates, templates and marketing materials from here.','cornsilk',300);"
                                              onmouseout="hideddrivetip();">Advanced Downloads</a></li>
                                          <li><a href="http://imax.relyonsoft.net/dealer/" target="_blank"
                                              onmouseover="ddrivetip('Buy Relyon Scratch Cards - Online','cornsilk',300);"
                                              onmouseout="hideddrivetip();">Scratch Card Download</a> [<a
                                              href="scm-procedure.pdf" target="_blank">?</a>]</li>
                                          <li><a title="Relyon Product Registration" href="#"
                                              onclick="window.open('http://imax.relyonsoft.com/register/','','width=765,height=500,top=100,left=100')"
                                              onmouseover="ddrivetip('Product can be registered to customers from here.','cornsilk',300);"
                                              onmouseout="hideddrivetip();">Product Registration</a></li>
                                          <li><a href="http://billing.relyonsoft.com" target="_blank"
                                              onmouseover="ddrivetip('You can rise Relyon Bill directly to end user.','cornsilk',300);"
                                              onmouseout="hideddrivetip();">Online Billing Application</a></li>
                                          <li><a href="http://www.relyonsoft.com/webmail" target="_blank"
                                              onmouseover="ddrivetip('Login to Relyon Webmail account directly from here. [If you have not configured to Email Client].','cornsilk',300);"
                                              onmouseout="hideddrivetip();">Relyon Emails</a></li>
                                          <li><a href="http://forum.relyonsoft.com" target="_blank"
                                              onmouseover="ddrivetip('Open discussion forum of Relyon, where anyone can come and put their views/discuss about Relyon Products.','cornsilk',300);"
                                              onmouseout="hideddrivetip();">Relyon Discussion Forum</a></li>
                                          <li><a href="http://www.payroll-india.com/download/RelyonContacts.htm"
                                              target="_blank"
                                              onmouseover="ddrivetip('Contact details of Relyon members for specific subjects.','cornsilk',300);"
                                              onmouseout="hideddrivetip();">Relyon Member Contacts</a></li>
                                          <li><a href="http://dealers.relyonsoft.com/home/Price-List-2012.pdf"
                                              target="_blank"
                                              onmouseover="ddrivetip('List of Product Prices.','cornsilk',300);"
                                              onmouseout="hideddrivetip();">Relyon Product Price list</a></li>
                                          <li><a href="http://relyonsoft.info/csd_prj/" target="_blank"
                                              onmouseover="ddrivetip('Manage Your Tasks.','cornsilk',300);"
                                              onmouseout="hideddrivetip();">Task Management</a></li>
                                        </ul>
                                      </div>
                                    </td>
                                  </tr>
                ...
                <tr>
                  <td valign="top" align="center">
                    <table width="99%" border="0" cellspacing="0" cellpadding="4" style="border:solid 1px #999999">
                      <tr>
                        <td colspan="9">
                          <div align="center" style=" color:#0099CC; font-size:16px"><strong>Lead Volume
                              Analysis</strong></div>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td width="12%"><input name="gobutton" type="button" class="formbutton" id="gobutton"
                            value="Go &raquo;" onclick="retrievedata()" />
                        ...
                        <td colspan="9">
                          <div id="container" style="width: 800px; height: 300px; margin: 0 auto">
                            <script type="text/javascript"
                              src="../functions/highchartsubadmin.js?dummy=<?php echo (rand()); ?>"></script>
                          </div>
                        </td>
                      </tr>
                    </table>
