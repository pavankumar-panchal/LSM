                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="6">
                              <tr>
                                <td width="101">Company Name:
                                  <input name="form_recid" type="hidden" id="form_recid" /><input name="cookie_usertype"
                                    type="hidden" id="cookie_usertype" value="<?php echo ($cookie_usertype); ?>" />
                                </td>
                                <td colspan="2"><input name="form_companyname" type="text" class="formfields"
                                    id="form_companyname" size="50" maxlength="50" /></td>
                                <td width="112">Contact person:</td>
                                <td width="362"><input name="form_name" type="text" class="formfields" id="form_name"
                                    size="50" maxlength="50" /></td>
                              </tr>
                              <tr>
                                <td>Address:</td>
                                <td colspan="4"><input name="form_address" type="text" class="formfields"
                                    id="form_address" size="126" maxlength="200" /></td>
                              </tr>
                              <tr>
                                <td>State:</td>
                                <td colspan="2"><select name="form_state" class="formfields" id="form_state"
                                ...
                                <td>
                                  <div id="districtdiv">
                                    <select name="form_district" class="formfields" id="form_district"
                              ...
                              <tr>
                                ...
                                <td>Place:</td>
                                <td><input name="form_place" type="text" class="formfields" id="form_place" size="50"
                                    maxlength="50" /></td>
                              </tr>
                              <tr>
                                <td>STD Code:</td>
                                <td colspan="2"><input name="form_stdcode" type="text" class="formfields"
                                    id="form_stdcode" size="50" maxlength="50" /></td>
                                <td>Landline:</td>
                                <td><input name="form_phone" type="text" class="formfields" id="form_phone" size="50"
                                    maxlength="50" /></td>
                              </tr>
                              <tr>
                                <td>Cell:</td>
                                <td colspan="2"><input name="form_cell" type="text" class="formfields" id="form_cell"
                                    size="50" maxlength="50" /></td>
                                <td>Email ID:</td>
                                <td><input name="form_email" type="text" class="formfields" id="form_email" size="50"
                                    maxlength="50" /></td>
                              </tr>
                              <tr>
                                <td valign="top">Product Name:</td>
                                <td colspan="2" valign="top"><select name="form_product" class="formfields"
                                    id="form_product">
                                    <?php
                                    echo ($productselect);
                                    ?>
                                ...
                                <td><select name="form_source" class="formfields" id="form_source">
                                    ...
                                    <option value="Incoming Email with clear reqt">Incoming Email with clear reqt
                                    </option>
                                    ...
                                    <option value="Saral TDS Pro free">Saral TDS Pro free</option>
                                    <option value="IndiaMart">India Mart</option>
                                    <option value="Justdial">Justdial</option>
                                    <option value="Adwords Campaign">Adwords Campaign</option>
                                    <option value="Seminar">Seminar</option>
                                    <option value="Software Suggest">Software Suggest</option>
                                    ...
                                    <!--                            <option value="GST Web Demo">GST Web Demo</option>-->
                                    <!--                            <option value="GST Web Download">GST Web Download</option>-->
                                    <!--                            <option value="SAB Web Demo">SAB Web Demo</option>-->
                                    <!--                            <option value="SAB Web Download">SAB Web Download</option>-->
                                    <!--                            <option value="SPP Web Demo">SPP Web Demo</option>-->
                                    <!--                            <option value="SPP Web Download">SPP Web Download</option>-->
                                    <!--                            <option value="TDS Web Demo">TDS Web Demo</option>-->
                                    <!--                            <option value="TDS Web Download">TDS Web Download</option>-->
                                    <!--                            <option value="STO Web Demo">STO Web Demo</option>-->
                                    <!--                            <option value="STO Web Download">STO Web Download</option>-->
                                    <option value="Accounts Partner">Accounts Partner</option>
                                    <option value="Taxation Partner">Taxation Partner</option>
                                    <option value="Payroll Partner">Payroll Partner</option>
                                    <option value="WhatsApp Campaigning">WhatsApp Campaigning</option>
                                    <option value="Techimply – HQL">Techimply – HQL</option>
                                  </select></td>
                              </tr>
                              <tr>
                                ...
                                <td width="204" valign="top">
                                  <div>
                                    ...
                                    <input type="checkbox" checked="checked" onclick="checkaspermapping();"
                                      name="aspermapping" id="aspermapping" />
                                    <label for="aspermapping">As per Mapping</label>

                                    <br />
                                    <br />
                                    <input style="display:none" type="checkbox" name="aspermapping" id="aspermapping"
                                      disabled="disabled" />



                                    <span> <select name="form_dealer" class="formfields" id="form_dealer"
                                        style="display:none;width:200px" onchange="ondealerselection()">
                                        <?php
                                        echo ($dealerselect);
                                        ?>
                                      </select> </span>
                                ...
                                <td width="101" valign="middle">
                                  <div id="help" style=" display:none; padding-bottom:10px;" align="left"><img
                                      class="imageclass" onmouseout="hidetooltip()"
                                      onmouseover="generatedealertooltip()" src="../images/help-image.gif" /></div>
                                </td>
                                <td valign="top">Remarks:</td>
                                <td><textarea name="form_leadremarks" cols="45" rows="5" class="formfields"
                                    style="padding:2px; font-family:Arial, Helvetica, sans-serif; font-size:12px"
                                    id="form_leadremarks"></textarea></td>
                              </tr>
                              <tr>
                                <td>&nbsp;</td>
                                <td colspan="2">&nbsp;</td>
                                <td>Website:</td>
                                <td><input name="form_website" type="text" class="formfields" id="form_website"
                                    size="50" maxlength="50" /></td>
                              </tr>
                              <tr>
                                ...
                                <td>
                                  <div align="center">
                                    <input name="new" type="button" class="formbutton" id="new" value="New"
                                      onclick="newentry();" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input name="save" type="button" class="formbutton" id="save" value="Add Lead >>"
