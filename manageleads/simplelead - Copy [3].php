						...
						?>
                                    ...
                                    <tr>
                                      <td colspan="2"><input name="dropterminatedstatus" type="checkbox" id="dropterminatedstatus" value="true" checked="checked" />
                                        <label for="dropterminatedstatus">Do not consider Order Closed / Fake / Exsting Users / Not Interested</label><br/><br/><input name="onlydemogiven" type="checkbox" id="onlydemogiven" value="true"  /> 
                                        <label for="onlydemogiven">Consider only the leads gone through a Demo [Demo Given]</label></td>
                                      <td valign="top">Lead Source:</td>
                                      <td valign="top"><select name="form_source" class="formfields" id="form_source" style="width:50%">
