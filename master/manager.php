                  ...
                  <td><form id="managerform" name="managerform" method="post" action="">
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        <tr>
                          ...
                          <td width="369"><input name="form_location" type="text" class="formfields" id="form_location" size="50" maxlength="50" /></td>
                        </tr>
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td><input type="checkbox" name="branchhead" id="branchhead" />
