...
switch($cookie_usertype)
{
	...
	case "Sub Admin":
		...
		$query = "SELECT id AS selectid, mgrname AS selectname FROM lms_managers where mgrname <> ''  ORDER BY mgrname";
...
$query7 = "select dlrdatatoexcel from lms_users where username = '".$cookie_username."'";
$result7 = runmysqlqueryfetch($query7);
$dlrdatatoexcel = $result7['dlrdatatoexcel'];
if($dlrdatatoexcel == 'yes')
{$disabled = "";}
else
...
<title>LMS | Dealer Data Chart</title>
...
<script src="../functions/reportsdlrdatachart.js?dummy=<?php echo (rand());?>" language="javascript"></script>
        ...
        <td height="300" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td style="border:solid 1px #999999"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                  <td><form id="filterform" name="filterform" onsubmit="return false;" autocomplete = "off" method="post" action="dlrdatatoexcel.php">
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
						...
						?>
                          ...
                          <td width="11%">Dealer/Manager:                              </td>
                          <td width="40%"><select name="dealerid" class="formfields" id="dealerid" style="width:48%">
                            <?php 
						echo($dealerselect);
						?>
                          </select></td>
