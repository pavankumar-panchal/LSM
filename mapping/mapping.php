...
<script src="../functions/mapping2.js?dummy=<? echo (rand());?>" language="javascript"></script>
<!--[if lt IE 7]>
        ...
        <td height="300" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td style="border:#666666 1px solid"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <td><strong>Configure mapping for &quot;<? echo($mapdlrcompany); ?>&quot;:</strong></td>
                </tr>
                <tr>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        ...
                        <tr>
                          <td width="147">State:
                            ...
                            <input name="form_dealerid" type="hidden" id="form_dealerid" value="<? echo($getdlrid); ?>" /></td>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <td width="42%"><strong>Mapping data for <? echo($mapdlrcompany); ?>:<span id="gridprocess"></span></strong></td>
