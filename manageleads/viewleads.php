...
<script src="../functions/viewleads.js?dummy=<? echo (rand());?>" language="javascript"></script>
                      ...
                      <td><form id="filterform" name="filterform" onsubmit="return false;" autocomplete = "off" method="post" action="viewleadstoexcel.php " >
                          <table width="100%" border="0" cellspacing="0" cellpadding="6">
                            <tr>
                              ...
                              <td width="37%"><input name="fromdate" type="text" class="formfields" id="DPC_fromdate" size="20" maxlength="10" value="<? echo($date); ?>" readonly="readonly"/>
                                <input type="hidden" name="hiddenfromdate" id="hiddenfromdate" /></td>
                              <td width="11%">To Date : </td>
                              <td width="40%"><input name="todate" type="text" class="formfields" id="DPC_todate" size="20" maxlength="10" value="<? echo($defaulttodate); ?>" readonly="readonly" />
						...
						?>
                            ...
                            <tr>
                              <td>From Date : </td>
                              <td><input name="filter_followupdate1" type="text" class="formfields" id="DPC_filter_followupdate1" size="20" maxlength="10" value="<? echo($defaulttodate); ?>" disabled="disabled" readonly="readonly"/>
                                <input name="filter_followupdate1hdn" type="hidden" class="formfields" id="filter_followupdate1hdn" value="" /></td>
                              <td>To Date : </td>
                              <td><input name="filter_followupdate2" type="text" class="formfields" id="DPC_filter_followupdate2" size="20" maxlength="10" value="<? echo($defaulttodate); ?>" disabled="disabled" readonly="readonly"/>
