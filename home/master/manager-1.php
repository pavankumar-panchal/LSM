...
<script src="../functions/managermaster.js?dummy=<?php echo (rand());?>" language="javascript"></script>
<script>
function dislogin()
{
                ...
                <tr>
                  <td><form id="managerform" name="managerform" method="post" action="">
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                        <tr>
                          <td width="93">Name:<input name="form_recid" type="hidden" class="formfields" id="form_recid" value="<?php echo ($id); ?>" /></td>
                          <td width="330"><input name="form_name" type="text" class="formfields" id="form_name" value="<?php echo ($name); ?>" size="50" maxlength="50" /></td>
                          <td width="100">Location:</td>
                          <td width="369"><input name="form_location" type="text" class="formfields" id="form_location" value="<?php echo ($location); ?>" size="50" maxlength="50" /></td>
                        </tr>
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td><input type="checkbox" name="branchhead" id="branchhead" <?php echo ($bh); ?> />
					 ...
					 ?>
                        ...
                        <tr>
                          <td>&nbsp;</td>
                          <td><input type="checkbox" name="transferuploadedleads" id="transferuploadedleads" <?php echo ($upload);?> />
                          ...
                          <?php echo ('<option value="'.$area.'">'.$area.'</option>'); ?>
