...
function lmscreatecookie($cookiename,$cookievalue,$sessionCookieExpireTime)
{
	 ...
	 setcookie($Encodename,$Encodevalue,time()+$sessionCookieExpireTime,"/");
	 ...
	 //Create a cookie
	 setcookie($rescookiename,$rescookievalue,time()+$sessionCookieExpireTime,"/");
		 return false;
...
function lmsdeletecookie($cookiename)
{
	...
	setcookie($Encodename, "");
	setcookie($rescookiename, "");
}
