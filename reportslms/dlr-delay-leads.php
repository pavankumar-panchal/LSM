...
$query7 = "select dlrdelayleadsxl from lms_users where username = '".$cookie_username."'";
$result7 = runmysqlqueryfetch($query7);
$dlrdelayleadsxl = $result7['dlrdelayleadsxl'];
if($dlrdelayleadsxl == 'yes')
{$disabled = "";}
else
...
<title>LMS | Dealer delay of leads</title>
...
<script src="../functions/reportsdlrdelayleads.js?dummy=<?php echo (rand());?>" language="javascript"></script>
        ...
        <td height="300" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td style="border:solid 1px #999999"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                  <td><form id="filterform" name="filterform" onsubmit="return false;" autocomplete = "off" method="post" action="dlr-delay-leads-xl.php">
                      <table width="100%" border="0" cellspacing="0" cellpadding="6">
                          <tr>
                            <td>From Date : </td>
                            <td><input name="fromdate" type="text" class="formfields" id="DPC_fromdate" size="25" maxlength="10" value="<?php echo($date); ?>" readonly="readonly"/></td>
                            <td>To Date : </td>
                            <td><input name="todate" type="text" class="formfields" id="DPC_todate" size="25" maxlength="10" value="<?php echo($defaulttodate); ?>" readonly="readonly"/></td>
                          </tr>
                          <tr>
                          <td width="48%" colspan="2" id="msg_box">&nbsp;</td>
