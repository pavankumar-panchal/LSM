...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
  ...
  <tr>
    <td valign="top" class="content"><table width="100%" border="0" cellspacing="0" cellpadding="2" >
      ...
      <tr>
          <td height="20" colspan="9"><div align="center" style=" color:#0099CC; font-size:16px"><strong>Lead Volume Analysis</strong></div></td>
        </tr>
         <tr>
          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td style="border:#666666 1px solid" ><table width="100%" border="0" cellspacing="0" cellpadding="2">
                    ...
                    <tr>
                      <td><div align="center"><a href="./dlrdownloads.php">Advanced Downloads of Relyon </a>| <a href="http://accountability.co.in/scm" target="_blank">Scratch Card Download Application</a></div></td>
                    </tr>
                  </table></td>
              </tr>
            </table></td>
