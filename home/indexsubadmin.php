    ...
    <td valign="top" class="content"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="300" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
          <tr>
            <td><strong><font style="font-size:16px" color="#0099CC">Welcome <? echo($sadname); ?>!!</font></strong></td>
          </tr>
          <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="100%" valign="top" style="border:solid 1px #999999"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                              ...
                              <tr>
                                <td height="20" valign="top" class="dashboard-box">Total Number of Leads: <? echo($todayleadcount_total); ?><br />
                                  <font color="#FF0000">CSD Region: <? echo($todayleadcount_csd); ?><br />
                                  </font><font color="#006600">KKG Region: <? echo($todayleadcount_kkg); ?></font><br />
                                  <font color="#0000FF">Bangalore: <? echo($todayleadcount_blr); ?></font><br />
                                  <br />
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td title="<? echo(number_format(($todayleadcount_csd*100)/$todayleadcount_total)); ?>%" width="<? echo(($todayleadcount_csd*100)/$todayleadcount_total); ?>%" height="20" bgcolor="#FF0000"></td>
                                      <td title="<? echo(number_format(($todayleadcount_kkg*100)/$todayleadcount_total)); ?>%" width="<? echo(($todayleadcount_kkg*100)/$todayleadcount_total); ?>%" bgcolor="#006600"></td>
                                      <td title="<? echo(number_format(($todayleadcount_blr*100)/$todayleadcount_total)); ?>%" width="<? echo(($todayleadcount_blr*100)/$todayleadcount_total); ?>%" bgcolor="#0000FF"></td>
                                    </tr>
                                    <tr>
                                      <td colspan="3">&nbsp;</td>
                                    </tr>
                ...
                <td width="25%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="100%" valign="top" style="border:solid 1px #999999"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                        ...
                        <tr>
                          <td valign="top" class="dashboard-box"><strong><font color="#0099CC"><? echo($sadname); ?></font></strong><br />
							Email: <? echo($sademail); ?><br />                            </td>
                        </tr>
                        <tr>
          ...
          <tr>
            ...
            <script type="text/javascript" src="../functions/highchartsubadmin.js?dummy=<? echo (rand());?>"></script>
            </div></td>
              </tr>
            </table></td>
          </tr>
