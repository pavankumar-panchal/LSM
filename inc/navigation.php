...
<?php if($cookie_usertype == "Admin" || $cookie_usertype == "Dealer") { ?>
  <li><a><span>Masters</span></a>
    <div>
      <ul>
<?php if($cookie_usertype == "Admin") { ?>
...
<?php } ?>
<?php if($cookie_usertype == "Admin" || $cookie_usertype == "Sub Admin" || $cookie_usertype == "Reporting Authority" || $cookie_usertype == "Dealer" || $cookie_usertype == "Implementer" || $cookie_usertype == "Dealer Member" ) { ?>
  <li><a><span>Leads</span></a>
    <div>
      <ul>
        <li><a href="../leads/uploadlead.php">Manual Upload of Lead</a></li>
<?php if($cookie_usertype == "Admin" || $cookie_usertype == "Sub Admin" || $cookie_usertype == "Reporting Authority") { ?>
          <li><a href="../leads/bulkleadtransfer.php">Bulk Lead Transfer</a></li> 
   <?php } ?>
   <?php if($cookie_usertype == "Admin" || $cookie_usertype == "Sub Admin" || $cookie_usertype == "Reporting Authority" || $cookie_usertype == "Dealer") { ?>
         <!-- <li><a href="../leads/bulksms.php">Send Bulk SMS</a></li> -->
<?php } ?>
<?php $showmcalistvalues = getshowmcapermissionvalue();
$showmcalistvaluessplit = explode('^',$showmcalistvalues); //echo($showmcalistvalues);
if($showmcalistvaluessplit[0] == 'yes') {?>
		 <li><a href="../leads/mcacompanies.php">MCA-Companies</a></li> <?php } ?>
      </ul>
    </div>
  </li>
<?php } ?>
...
<?php } ?>
<?php if($cookie_usertype == "Admin" || $cookie_usertype == "Sub Admin") { ?>
...
<?php } ?>
<?php if($cookie_usertype == "Sub Admin") { ?>
        <li><a href="../reportslms/mappinginformation.php">Mapping Information</a></li>
